...
class SaleOrder(models.Model):
    ...
    def action_cancel(self):
        ...
        for sale_order in self:
            if sale_order.state == 'sale' and sale_order.order_line:
                ...
                documents = self.env['stock.picking']._log_activity_get_documents(sale_order_lines_quantities,
                                                                                  'move_ids', 'UP')
    ...
    def _show_cancel_wizard(self):
        ...
        for order in self:
            if any(picking.state == 'done' for picking in order.picking_ids) and not order._context.get(
...
class SaleOrderLine(models.Model):
    ...
    def _compute_qty_at_date(self):
        ...
        # for value in treated:
        #     print(value.product_uom_qty)
